        ...
        <div className='flex justify-center relative my-20-z-10'>
            <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
                <h2 className='uppercase tracking-widest text-xs text-center text-blue-100 max-w-80'>
                    Página dinâmica com Next.JS
                </h2>
                <TextGenerateEffect
                    className='text-center text-[40px] md:text-5xl lg:text-6xl'
                    words='Transformando Conceitos em Realidade'
                />
                <p className='text-center md:tracking-wider my-4 text-sm md:text-lg lg: text-2x1'>
                    Olá, eu sou Vinicios C. Soares. Desenvolvedor FullStack Python, React-Native, Next.JS.
                </p>
                <a href="#about">
                    <MagicButton 
                        title='Meu Trabalho'
